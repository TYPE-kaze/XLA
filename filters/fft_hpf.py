...
def high_pass_filter(channel, filter_size, intensity = 1):
...
b_filtered = high_pass_filter(b, filter_size, intensity)
g_filtered = high_pass_filter(g, filter_size, intensity)
r_filtered = high_pass_filter(r, filter_size, intensity)
